  ...
  return (
    <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-8 space-y-5 sm:space-y-6 pb-24 md:pb-12">
      ...
      <div className="p-4 sm:p-5 bg-orange-50/70 dark:bg-orange-950/30 border border-orange-200 dark:border-orange-900/40 rounded-2xl text-xs sm:text-sm text-orange-950 dark:text-orange-200 leading-relaxed shadow-2xs">
        <strong className="font-bold text-orange-900 dark:text-orange-300">Zero Fake Data standarti:</strong> Platformada hech qanday soxta API ma'lumotlari yaratilmaydi. Manba sozlanmagan bo'lsa, holat doimo <code className="bg-orange-100 dark:bg-orange-900/60 text-orange-800 dark:text-orange-300 px-1.5 py-0.5 rounded font-mono text-xs">NOT_CONFIGURED</code> ko'rinishida bo'ladi. Hozirda asosiy real ma'lumotlar oqimi ro'yxatdan o'tgan rasmiy sotuvchilar orqali amalga oshirilmoqda.
      </div>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
          {sources.map(src => (
            <div 
              key={src.id} 
              className="bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 rounded-2xl p-5 sm:p-6 flex flex-col justify-between shadow-2xs hover:border-orange-300 dark:hover:border-orange-500/50 transition-all"
            >
              <div>
                <div className="flex items-center justify-between mb-4 gap-2">
                  <div className="flex items-center gap-3 min-w-0">
                    <div className="w-10 h-10 rounded-xl bg-orange-50 dark:bg-orange-950/50 text-orange-600 dark:text-orange-400 flex items-center justify-center border border-orange-100 dark:border-orange-800/60 shrink-0">
              ...
              <div className="pt-3 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between text-[11px] text-slate-500 dark:text-slate-400 font-numeric">
                <span>Adapter: <strong className="text-slate-800 dark:text-slate-200 font-mono">DataSourceAdapter</strong></span>
